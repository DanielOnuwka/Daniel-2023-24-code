...
def main():
    ...
    while play_again:
        ...
        words = ["hangman", "connecticut", "school", "bodywash", "clothing",
                 "computer", "python", "hilltop", "lodge", "table",
                 "sweatpants", "pomfret", "friends", "clocks", "biology",
                 "algebra", "suitcase", "knives", "daniel", "shampoo"]  
        
        
        chosen_word = random.choice(words).lower()
        player_guess = None # will the players guess
...
""")
        ...
        while (attempts != 0 and "-" in word_guessed):
            ...
            try:
                ...
                if not player_guess.isalpha(): # check the input is a letter. Also checks the input has been made.
